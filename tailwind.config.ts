	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				'onboarding-from': '#110A30',
				'onboarding-to': '#3B2D71',
				'onboarding-highlight': '#5CE5D5',
				'onboarding-action': '#FF6AC2',
			},
			borderRadius: {
				lg: 'var(--radius)',
			...
			backgroundImage: {
				...
				'onboarding-gradient': 'linear-gradient(135deg, #110A30, #3B2D71)',
			},
			boxShadow: {
				...
				'onboarding': '0 10px 25px rgba(17, 10, 48, 0.3)',
			},
			letterSpacing: {
				tight: '-0.025em',
				tighter: '-0.05em',
