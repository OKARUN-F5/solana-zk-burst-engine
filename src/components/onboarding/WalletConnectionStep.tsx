...
const WalletConnectionStep: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <h2 className="font-jakarta font-bold text-2xl tracking-onboarding mb-2">Connect Your Wallet</h2>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <div className="font-jakarta font-medium tracking-onboarding flex items-center">
                    {wallet.name}
                    {wallet.popular && (
                      <span className="ml-2 text-xs bg-onboarding-highlight/20 text-onboarding-highlight px-2 py-0.5 rounded-full">
                        Popular
                      </span>
                    )}
                  </div>
              ...
              {selectedWallet === wallet.id && <Check className="h-5 w-5 text-onboarding-highlight" />}
            </button>
          </motion.div>
        ))}
      </div>
      ...
      <div className="mt-6">
        <motion.div
          ...
          className="bg-white/5 border border-white/10 rounded-lg p-4 flex items-start"
        >
          <Info className="h-5 w-5 text-onboarding-highlight mt-0.5 mr-3 flex-shrink-0" />
